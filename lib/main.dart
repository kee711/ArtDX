    ...
    theme: ThemeData(
        appBarTheme: AppBarTheme(
            ...
            titleTextStyle: TextStyle(
                color: Colors.black, fontSize: 17, fontWeight: FontWeight.w100),
  ...
  List data_local = [
    {
      ...
      "docent": "강유진 도슨트",
      "keypoint":
          " This poster features a modern girl with Pre-Raphaelite hair holding a lighted cigarette, symbolizing the contemporary femininity of the time.",
      "description":
    ...
    },
    {
      ...
      "docent": "기민성 도슨트",
      "keypoint":
          "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi ac maximus massa. Ut tellus diam, scelerisque eget orci nec,",
      "description":
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    CarouselSlider(
                        items: data_local
                            .map((item) => Center(
                                child: Image.asset(data_local[id]["image"],
                    ...
                    //작품 기본 정보
                    SizedBox(height: 10),
                    Text(data_local[id]["artist"],
                        style: AppTextStyle.artSubtitle),
                    Text(data_local[id]["name"], style: AppTextStyle.artTitle),
                    Text(data_local[id]["date"], style: AppTextStyle.cardTitle),
                    Text(data_local[id]["medium"],
                        style: AppTextStyle.artSubtitle),
                    Text(data_local[id]["size"],
                        style: AppTextStyle.artSubtitle),
